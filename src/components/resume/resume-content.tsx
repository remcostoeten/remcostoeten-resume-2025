	...
	return (
		<div className='space-y-24'>
			<section id='about' className='scroll-mt-24'>
				<h3 className='mb-4 text-sm font-semibold uppercase tracking-widest text-foreground lg:sr-only'>
					About
				</h3>
				<div className='space-y-4 text-muted-foreground leading-relaxed'>
					...
					<p>
						...
						<span className='font-medium text-foreground'>
							Brainstud / Allyyoucanlearn
						</span>
						, building modern e-learning platforms with Next.js and TypeScript under the
