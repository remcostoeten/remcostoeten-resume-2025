		...
		switch (currentView) {
			...
			case 'topics':
				return {
					title: 'Topics',
					subtitle:
						'A collection of topics I write about, ranging from technical deep dives to design philosophy.',
					action: (
						<button
					...
					subtitle: (
						<div className='space-y-4'>
							...
							<div className='leading-relaxed space-y-4 text-muted-foreground'>
								<p>
									Remco Stoeten, 28 y/o dutch software engineer focused on
									front-end with a degree in{' '}
									<span className='text-foreground/80 italic'>
										graphic design
									</span>
									. Roughly{' '}
									<span className='text-foreground/80 italic'>8 years</span> of
									experience across b2b/b2c{' '}
									<span className='text-foreground/80 italic decoration-dotted underline underline-offset-4'>
										e-commerce
									</span>
									, in-house{' '}
									<span className='text-foreground/80 italic decoration-dotted underline underline-offset-4'>
								...
								<p>
									Big fan of proper{' '}
									<span className='text-foreground/80 italic'>DX & tooling</span>,{' '}
									<span className='text-foreground/80 italic'>
										design systems
									</span>
									, and{' '}
									...
									. Besides React/Next I have been tinkering around with{' '}
									<span className='text-foreground/80 italic'>
										Lua, SolidJS, Qwik, Svelte, Rust, Python
									</span>{' '}
									and <span className='text-foreground/80 italic'>Shell</span>,
									<span className='text-foreground/80 italic decoration-dotted underline underline-offset-4'>
									...
									to build more complete solutions. Always learning, always
									shipping.
								</p>
							</div>
						</div>
			...
			<main className='px-6 py-12 md:px-12 md:py-24 max-w-3xl mx-auto w-full flex-grow'>
				{headerData && (
					<header className='mb-12 flex flex-col sm:flex-row sm:items-start justify-between gap-8 animate-enter'>
						...
						<div className='flex-shrink-0 sm:pt-2'>{headerData.action}</div>
					</header>
				)}
				...
				{currentView === 'home' && (
					<>
						...
						<div
							className='relative mb-8 group animate-enter'
