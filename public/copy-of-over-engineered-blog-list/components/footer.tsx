...
import { Github, Linkedin, Mail, Heart, Sparkles, ArrowUpRight, GitCommit, Loader2 } from "lucide-react"
...
export default function Footer() {
    ...
    return (
        <footer className="border-t border-border/30 mt-16 relative overflow-hidden w-full group/footer">
            ...
            >
                <div 
                    className="absolute top-[5%] left-[5%] w-[500px] h-[500px] bg-accent/10 blur-[120px] animate-blob-float mix-blend-screen"
                />
                <div 
                    className="absolute top-[15%] right-[5%] w-[400px] h-[400px] bg-accent/5 blur-[90px] animate-blob-sway animation-delay-2000 mix-blend-screen" 
                />
                <div 
                    className="absolute bottom-[20%] left-1/2 -translate-x-1/2 w-[600px] h-[400px] bg-accent/5 blur-[140px] animate-blob-pulse animation-delay-4000 mix-blend-screen" 
                />
                <div className="absolute inset-0 bg-gradient-to-t from-background via-transparent to-transparent opacity-90" />
            </div>

            <div ref={contentRef} className="max-w-3xl mx-auto px-6 md:px-12 py-12 sm:py-16 relative z-10">
