...
const PROJECTS = [
	{
		title: 'Next-Forge',
		description:
			'Production-ready Next.js monorepo starter. Turbo, atomic design, and strict architectural boundaries.',
	...
	},
	{
		title: 'Planorama',
		description:
			'End-to-end SaaS platform for resource planning. Features real-time collaboration and analytics.',
	...
	},
	{
		title: 'Drizzleasy',
		description:
			'Visual database schema viewer & manager for Drizzle ORM. View tables, relations, and generate migrations visually.',
	...
	},
	{
		title: 'Fync',
		description:
			'Lightning fast file synchronizer written in Rust. Designed to sync dotfiles across machines instantly.',
		tags: ['Rust', 'CLI', 'Async'],
		stars: 67,
		forks: 8,
