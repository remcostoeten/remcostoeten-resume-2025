...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    summary: 'Building a simple personal website that spiraled into over-engineering territory: custom npm packages, monorepo setup, multiple APIs integration, and several scrapped features along the way. A tale of how personal projects can become unnecessarily complex.',
    date: '2025-10-06',
...
This approach ensures that while your eyes enjoy the show, assistive technology gets the data immediately.`
  },
  {
    ...
    summary: 'Exploration of how we handle ephemeral state when moving from client-side rendering to a server-first architecture. Pitfalls, patterns, and performance implications.',
    date: '2024-09-28',
...
Interactivity is the dividing line. Does it need \`useState\`? Client. Is it just fetching data? Server. It sounds simple, but the boundaries can get blurry when you're passing props deeply.`
  },
  {
    ...
    summary: 'A look into why TypeScript has become indispensable in my daily workflow. It is not just about types; it is about confidence, refactoring capabilities, and self-documenting code.',
    date: '2024-08-12',
